  ...
  var I = {
    ...
    updateSlides: function () {
      ...
      if (
        ...
        p(i, "--swiper-centered-offset-before", -m[0] + "px"),
          p(
            i,
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? a < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (a = e.getSlideIndex(
                  f(s, `${l}[data-swiper-slide-index="${r}"]`)[0],
                )),
                n(() => {
                  e.slideTo(a);
                }))
  ...
  var G = {
    ...
    loopFix: function (e) {
      ...
      const P = b ? Math.ceil(d.length / m.grid.rows) : d.length,
        L = (b ? d[a].column : a) + (f && void 0 === r ? -g / 2 + 0.5 : 0);
      if (L < w) {
        C = Math.max(w - L, v);
  ...
  function V(e) {
    ...
    if (m > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (S >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? w : g + T)
          : t.slideTo(g)),
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((r) => {
          if (!s[r] && !0 === s.auto) {
            let a = f(e.el, `.${i[r]}`)[0];
            a || ((a = g("div", i[r])), (a.className = i[r]), e.el.append(a)),
              (s[r] = a),
              (t[r] = a);
          }
        }),
  ...
  function te(e) {
    ...
    function u() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((n = S(r[0], t.isHorizontal() ? "width" : "height", !0)),
            p.forEach((e) => {
      ...
      ae(),
        ...
        document.querySelector(".people__slider") &&
          new J(".people__slider", {
            ...
            breakpoints: {
              320: { slidesPerView: 1, spaceBetween: 60, autoHeight: !0 },
              405: { slidesPerView: 2, spaceBetween: 60 },
              992: { slidesPerView: 3, spaceBetween: 60 },
              1587: { slidesPerView: 4, spaceBetween: 60 },
            },
            on: {},
          });
    });
